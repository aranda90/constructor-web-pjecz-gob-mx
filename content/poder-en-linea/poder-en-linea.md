    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card destacados-card mb-2">
                ...
                <div class="card-body" style="height:130px;">
                    <a href="https://poderenlinea.gob.mx/" target="_blank"><h3 class="card-title mb-0">Ingresar a Poder en Línea Web</h3></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-8 col-xs-12 mt-2">
        <img class="img-fluid" style="border-radius:5px;" src="poder-en-linea-app.jpg">
    </div>
    <div class="col-md-2"></div>
</div>
<div class="row">
...
<div class="row">
    ...
    <div class="col-md-6 mt-4 text-center">
        <a href="https://storage.googleapis.com/pjecz-gob-mx/Consultas/Poder%20en%20Linea/Manual_Poder_en_Linea_App.pdf" style="font-size:20px;"><b>Manual del usuario para Poder en Líne@</b></a>
    </div>
    <div class="col-md-3"></div>
</div>
<br>
